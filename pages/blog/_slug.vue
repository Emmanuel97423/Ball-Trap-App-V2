            ...
            <div class="blog_single_content">
              ...
              <div class="blog_single_widget">
                ...
                <div class="blog_single_first_Widget">
                  <h2 v-if="this.$route.params.slug">
              ...
              <div class="related_blogs">
                <div class="row">
                  <div
                    v-for="blogItem in blogItems.slice(0, 2)"
                    :key="blogItem.id"
                            ...
                            <div class="d-flex align-items-md-center">
                              ...
                              <div class="ml-auto">
                                <a href="#" class="comment-reply"
                                  ><i class="ion-reply-all"></i>Reply</a
                                >
                              </div>
                            </div>
                            <p>
      ...
      meta: [
        {
          ...
          name: "description",
          content:
            "Blog Single page - AndShop Ecommerce Vue js, Nuxt js Template",
        },
      ],
    };
  },
